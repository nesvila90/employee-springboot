...
public class DocumentationConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors
                        .basePackage("com.fonyou.employee.web.rest.api"))
    ...
    private ApiInfo apiEndPointsInfo() {
        return new ApiInfoBuilder().title("Employee REST API - FONYOU")
                .description("API REST for microservice APP for entity employee.")
