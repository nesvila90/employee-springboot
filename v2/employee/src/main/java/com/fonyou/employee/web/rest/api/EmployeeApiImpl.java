...
@CrossOrigin(origins = {"*", "http://localhost:4200/*", "http://localhost:4200/person", "http://localhost:4200"})
...
public class EmployeeApiImpl {
     ...
     * @since 0.0.1 16/10/2019
     */
    @ApiOperation(value = "Register a Employee", response = List.class)
    @ApiResponses(value = {
     ...
     * @since 0.0.1 16/10/2019
     */
    @ApiOperation(value = "Update a Employee available", response = List.class)
    @ApiResponses(value = {
     ...
     * @since 0.0.1 16/10/2019
     */
    @ApiOperation(value = "Remove a Employee available", response = List.class)
    @ApiResponses(value = {
     ...
     * @since 0.0.1 16/10/2019
     */
    @ApiOperation(value = "View a Employee available", response = List.class)
    @ApiResponses(value = {
     ...
     * @since 0.0.1 16/10/2019
     */
    @ApiOperation(value = "View a list of Employee available", response = List.class)
    @ApiResponses(value = {
